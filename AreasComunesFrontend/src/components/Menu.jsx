...
// import { SOLICITUD_CREATE_URL, SOLICITUD_LIST_URL } from "../navigation/Constant";
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
              ...
              {/* <NavDropdown title="Solicitud" id="basic-nav-dropdown">
                <NavDropdown.Item onClick={() => { navigate(SOLICITUD_CREATE_URL) }} >Crear Solicitud</NavDropdown.Item>
                <NavDropdown.Item onClick={() => { navigate(SOLICITUD_LIST_URL) }} >Lista de Solicitudes de Reserva</NavDropdown.Item>
              </NavDropdown> */}
